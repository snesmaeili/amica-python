"""Direct tests for jamica.accumulators module."""
...
def test_zero_stats():
    from jamica.accumulators import zero_stats
...
def test_add_stats():
    from jamica.accumulators import add_stats, zero_stats
...
def test_chunk_stats_additivity():
    ...
    from jamica.accumulators import add_stats, compute_chunk_stats
    from jamica.backend import jnp
